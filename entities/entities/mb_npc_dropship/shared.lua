...
function ENT:SetupDataTables()
	...
	self:NetworkVar("Float", 5, "NPCHealthMult")
	self:NetworkVar("Float", 6, "DropRadius")

	self:NetworkVar("Bool", 0, "NPCsDropped")

	self:NetworkVar("Int", 0, "NPCCount")

	self:NetworkVar("String", 0, "VehicleModel")
	self:NetworkVar("String", 1, "NPCClass")
	self:NetworkVar("String", 2, "NPCWeapon")
	self:NetworkVar("String", 3, "NPCTeam")
	self:NetworkVar("String", 4, "NPCStance")
	self:NetworkVar("String", 5, "NPCModel")
end
